= A Rust implementation of the Zish format
:toc: preamble


A Rust library for the https://github.com/tlocke/zish[Zish] format,
released under the https://github.com/tlocke/zish_python/blob/master/LICENSE[Unlicense].

image::https://github.com/tlocke/zish_rust/workflows/zish_rust/badge.svg[Build Status]
